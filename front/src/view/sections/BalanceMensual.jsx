...
const BalanceMensual = ({ gastosEntrada, gastosSalida, año }) => {
  const [balancePorMes, setBalancePorMes] = useState([]);

  useEffect(() => {
    function calcularBalancePorMes(gastosEntrada, gastosSalida, año) {
    ...
    gastosSalida &&
      gastosEntrada &&
      año &&
      setBalancePorMes(calcularBalancePorMes(gastosEntrada, gastosSalida, año));
